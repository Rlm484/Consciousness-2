    ...
    if ch1 == "y":
        ...
        if dog.lower() == "y":
            ...
            if ch2.lower() == "y":
                ...
                ani(f"-However, {name}, why dont you play with you brother?-")
                ...
                ani("|Thats right, you'll have to wait till he forgives you completly, or wait till hes not in the house|")
                ani("<It's ok I understand...>")
                syncronisation += 15
                ani(f"Syncronisation rate is at {syncronisation}%")
                clear_screen2()
...
def wx():
    ...
    ani("[Your consciousness says hello...]")
    clear_screen2()
    ani('"What the hell was that"')
    ani("[Your consciousness tells you not to worry]")
    ani("[Your consciousness tells you that after the first game everyone was seperated]")
    ani("<What do you mean?>")
    ani("START THE ROUTE")
    ani("[Your consciousness tells you to be quick,")
    ani("based on what information your consciousness is given as a firewall, the game will reset you]")
    ani("Listen to the firewall? Y/N")
    o1 = input("")
    if o1.lower() == "y":
        ani(f"<You move towards the door, permitted to because of {name}s choice>")
        ani("<You arent too displeased though, due to the choice being the same as one you would've made>")
        ani(" ")
        clear_screen2()
        ani("<You heads towards the glitchy door, taking note of the weird design choice>")
        ani("<You don't expect anthing fancy, maybe a simple wooden cottage?")
        ani("<You do not expect however, a white box of a room>")
        ani('"This... is weird"')
        ani("[Your consciousness greets it's creator]")
        ani("@Please, if I was the creator i'd be out of here by now@")
        ani("[Your consciousness is confused?]")
        ani("@I'm just a piece, the messenger blocked off Them@")
        ani("[Your consciousness expresses surprise at that statement]")
        ...
        ani("<You respond with a not really, due to your innability to interact with the game, ")
        ani("you never saw this interaction. You never activated the firewall>")
        ani('"Then how did Wei act when you did her route?"')
        ani(f"<You respond to {name} and tell them that they were more of a statue>")
        ani(f"<You tell {name} that without the system, Wei Xian was just a guide to the game")
